...
<html lang="es">
    <head>
        ...
        <meta charset="UTF-8">
        <title><c:out value="${requestScope.path.toUpperCase()}"></c:out></title>
    ...
    <body>
                    ...
                    <div class="login-container">
                        ...
                        <div class="login-data" id="login-data">
                            <div class="container-login" id="container-login">
                                <form id="login-form" class="form-login-register 
                                    <c:if test="${requestScope.path.equals('login')}">
                                ...
                                <form id="register-form" class="form-login-register 
                                    <c:if test="${requestScope.path.equals('registro')}">
                                        <c:out value="active"></c:out>
                                    </c:if>">
        ...
        <script src="js/utils/modal/je-modal.js"></script>
        <script src="js/pages/components/loader.js"></script>
        <script src="js/pages/login-registro/login-registro.js" type="text/javascript"></script>
    </body>
